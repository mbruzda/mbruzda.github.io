...
function handleLeaflet(){
    ...
    function success(position) {
      ...
      var tiles = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{latitude}/{longitude}/13?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
        maxZoom: 18,
